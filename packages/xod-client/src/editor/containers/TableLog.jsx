      ...
      <div className="TableLog">
        <div className="TableLog-header">
          <div className="sourceSelector">
            <label htmlFor="tablelog-source">Source:</label>
            <select
              id="tablelog-source"
          ...
          <div className="sheets">
            <div className="currentSheet">
              Sheet: {this.props.sheetIndex + 1} / {sheetAmount}
            </div>
            <button
              className="prev"
          ...
          <div className="actions">
            <button
              className="copy-log Button Button--light"
            ...
            <button
              className="save-log Button Button--light"
